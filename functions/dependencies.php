...
function enqueue_integral_scripts() {
    wp_enqueue_script('Bootstrap-5.1.3', 'https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/js/bootstrap.bundle.min.js', array('jquery'), null, true, null);
...
function enqueue_integral_styles() {
    wp_enqueue_style('bootstrap-5.1.3', 'https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css', array(), null);
