<nav class="navbar fixed-top iss-navbar" style="background:#222;">
	<div class="container-fluid">
		<a class="navbar-brand" href="<?php echo get_home_url(); ?>">
			<img src="<?php echo get_home_url(); ?>/wp-content/uploads/integrity-sound-logo.svg" class="img-fluid d-inline-block align-text-top" width="240" height="46" alt="Integrity Sound Solutions logo" />
		</a>
